...
public static class SeasonEndpoints
{
    ...
    public static RouteGroupBuilder MapSeasonEndpoints(this RouteGroupBuilder api)
    {
        ...
        // TODO P0-03: .RequireAuthorization("Authenticated") - the policy is built in parallel by
        // P0-03 and does not exist yet. The contract scope for this route is Auth.
