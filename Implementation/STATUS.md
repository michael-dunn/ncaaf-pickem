...
| 2026-09-18 | P2-05 | `src/NcaafPickEm.Infrastructure/NcaafPickEm.Infrastructure.csproj` | Added a `ProjectReference` to `tests/NcaafPickEm.Fixtures` so the fixture providers can read the embedded JSON at runtime, not only in tests (D-028). |
