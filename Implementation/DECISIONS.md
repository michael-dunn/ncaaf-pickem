...
D-015  2026-09-18  P0-05  `ISeasonWeekSource` is async and lives in Domain; the 2026 fixture calendar is code, not JSON; `GET /api/seasons/{year}/weeks` answers 404 for a season the calendar does not know.
